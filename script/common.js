...
function deleteLocalWgt(app) {
    ...
    switch (true) {
        ...
        case app.coding == "WaterStarOne-AM-S8":
            wgtName = "Audit"
            break;
        case app.coding == "WaterStarOne-WRP-S8":
            wgtName = "CqMeterReading"
            break;
        case app.coding == "WaterStarOne-AM-S8-CQ":
            wgtName = "ReviewManagement"
            break;
        case app.coding == "WaterStarOne-Inspection-S9":
...
function appIsExists(item, callback) {
    ...
    var meterManageNumber = 0
        ...
        CQmeterReadingNumber=0
        CQReviewManagement=0
        GISInspectionNumber=0
    var ret = {
        status: false,
        appName: ""
    };
                ...
                if (item != undefined) {
                    switch (true) {
                        ...
                        case item.productCode == 'WaterStarOne-AM-S8':
                            ...
                            callback(ret);
                            break;
                        case item.productCode == 'WaterStarOne-WRP-S8':
                            ret.appName = "抄表平台";
                            callback(ret);
                            break;
                        case item.productCode == 'WaterStarOne-AM-S8-CQ':
                            ret.appName = "稽核管理";
                            callback(ret);
                            break;
                        case item.productCode == 'WaterStarOne-Inspection-S9':
                            ret.appName = "管网巡检系统";
                            callback(ret);
                            break;
                    }
                    ...
                    if (item != undefined) {
                        ...
                        switch (true) {
                            ...
                            case appList[i].coding == 'WaterStarOne-AM-S8':
                                auditNumber++;
                                break;
                            case appList[i].coding == 'WaterStarOne-WRP-S8':
                                CQmeterReadingNumber++;
                                break;
                            case appList[i].coding == 'WaterStarOne-AM-S8-CQ':
                                CQReviewManagement++;
                                break;
                            case appList[i].coding == 'WaterStarOne-Inspection-S9':
                                GISInspectionNumber++;
                                break;
                        }
                        if (sumNUmber == appList.length) {
                            ...
                            if (CQmeterReadingNumber == 0) {
                                ret.appName += "抄表平台,";
                            }
                            if (auditNumber == 0) {
                                ret.appName += "稽核管理,";
                            }
                            if (CQReviewManagement == 0) {
                                ret.appName += "稽核管理,";
                            }
                            if (GISInspectionNumber == 0) {
                                ret.appName += "管网巡检系统,";
                            }
                            if (meterManageNumber != 0 && meterReadingNumber != 0 && auditNumber != 0 && CQmeterReadingNumber!=0 && CQReviewManagement!=0 && GISInspectionNumber!=0) {
                                ret.status = true;
                            } else {
...
function ConfirmTaskAll(type) {
    ...
    appIsExistAll(function(ret) {
        if (ret.status) {
            ...
            if (ret.appName == "") {
                ret.appName = '表务管理,稽核管理,抄表管家,抄表平台';
            }
            api.toast({
...
function checkZipDownloadSuccess(data, callback) {
    var fs = api.require("fs");
    var publicExist = fs.existSync({
        path: 'fs://wgt/public'
    });
    // alert(JSON.stringify(publicExist))
    if (publicExist.exist) {
        downloadS8();
        return false;
    }
    ...
    function downloadS8(){
      ...
      switch (true) {
          case data.coding == "WaterStarOne-MRH-S8": //抄表管家
              var appWgtZipUrlName = "MeterReading"
              break;
          case data.coding == "WaterStarOne-MMS-S8": //表务管理
              var appWgtZipUrlName = "MeterManage"
              break;
          case data.coding == "WaterStarOne-AM-S8": //稽核管理
              var appWgtZipUrlName = "Audit"
              break;
          case data.coding == "WaterStarOne-Cloud-S9": //公共文件
              var appWgtZipUrlName = "public"
              break;
          case data.coding == "WaterStarOne-WRP-S8": //重庆电磁表
              var appWgtZipUrlName = "CqMeterReading";
              break;
          case data.coding == "WaterStarOne-AM-S8-CQ": //重庆稽核
              var appWgtZipUrlName = "ReviewManagement";
              break;
          case data.coding == "WaterStarOne-Inspection-S9": //南京溧水 巡检APP
              var appWgtZipUrlName = "GISInspection";
              break;
      }
      ...
      fs.exist({
          ...
          if (ret.exist) {
            // 判断文件里面的版本信息
            switch (true) {
                case data.moduleCode == "WaterStarOne-MRH-S8": //抄表管家
                    var wgtName = "MeterReading";
                    break;
                case data.moduleCode == "WaterStarOne-MMS-S8": //表务管理
                    var wgtName = "MeterManage";
                    break;
                case data.moduleCode == "WaterStarOne-AM-S8": //稽核管理
                    var wgtName = "Audit";
                    break;
                case data.moduleCode == "WaterStarOne-Cloud-S9": //公共文件
                    var wgtName = "public";
                    break;
                case data.moduleCode == "WaterStarOne-WRP-S8": //重庆电磁表
                    var wgtName = "CqMeterReading";
                    break;
                case data.moduleCode == "WaterStarOne-AM-S8-CQ": //重庆稽核
                    var wgtName = "ReviewManagement";
                    break;
                case data.moduleCode == "WaterStarOne-Inspection-S9": //重庆稽核
...
function downloadArchiveZip(coding, callback) {
    ...
    db.selectSql({
        name: 'Wsdatabase',
        sql: 'SELECT * FROM VersionInfoSheets where moduleCode="'+coding+'"'
    }, function(ret, err){
      // console.log(JSON.stringify(err));
        if( ret.status ){
          if(ret.data.length>0){
            var data = ret.data[0];
            var newpacketUrl = data.packetUrl.replace(/(^\s*)/g, "");
            var downloadUrl = apiUrl + newpacketUrl;
            api.download({
                url: downloadUrl,
                savePath: 'fs://' + data.moduleName + '.zip',
                report: true,
                cache: false,
                allowResume: true
            }, function(ret, err) {
                if (ret.state == 1) {
                    //下载成功
                    unarchiveToWgt(data.moduleName, function(ret) {
                        callback(ret);
                    });
                }else if(ret.state == 2){
                  // alert('fs://' + data.moduleName + '.zip'+"下载失败");
                  alert("正在下载中，请稍后点击进入")
                  api.hideProgress();
                  return false;
                }else if(ret.state == 0){
...
function dataQuery(fromCb, callback) { //fromCb 表示不是抄表管家更新基础数据 ，true表示是更新抄表管家基础数据
    ...
    var ret = db.selectSqlSync({
        name: 'CBtest',
        sql: 'SELECT * FROM MRM_USER_BEAN where CBBZ=1 and ZTSCCG=0 and CWXX=" " and ZXBLX!="2"'
    });
    if (ret.status) {
        if (ret.data.length > 0) {
            returnRet.appName = '抄表员' + ret.data[0].userName;
            callback(returnRet);
            return;
        }
    }
    ...
    var ret = db.selectSqlSync({
        name: 'CBtest',
        sql: 'select * from MRM_WORKORDER_BEAN where SFSC="0"'
    });
    if (ret.status) {
        if (ret.data.length > 0) {
            returnRet.appName = '抄表员' + ret.data[0].userName;
    ...
    var ret = db.selectSqlSync({
        name: 'CBtest',
        sql: 'select * from MRM_WORKORDERPHOTOS_BEAN where SFSC=0 and YHBH in (select YHBH from MRM_WORKORDER_BEAN where SFSC=1)'
    });
    if (ret.status) {
        if (ret.data.length > 0) {
            returnRet.appName = '抄表员' + ret.data[0].userName;
    ...
    var ret = db.selectSqlSync({
        name: 'CBtest',
        sql: 'select * from MRM_WATER_METER_USER where SFXG="1" and SFSC="0"'
    });
    if (ret.status) {
        if (ret.data.length > 0) {
            returnRet.appName = '抄表员' + ret.data[0].userName;
    ...
    var ret = db.selectSqlSync({
        name: 'CBtest',
        sql: 'select * from MRM_WATER_METER_PHOTOS where SFSC=0 and YHBH in (select YHBH from MRM_WATER_METER_USER where SFXG=1 and SFSC=1)'
    });
    if (ret.status) {
        if (ret.data.length > 0) {
            returnRet.appName = '抄表员' + ret.data[0].userName;
...
function downloadLogo(){
  fnGet('services/app/Tenant/GetTenantPacketUrlAsync', {}, false, function(ret, err) {
      ...
      if (ret && ret.success) {
        ...
        // console.log('http://'+$api.getStorage('apiUrl')+ ret.result);
        api.download({
            url: downloadUrl,
...
function logoShow(){
    ...
    if (logoret.status) {
        ...
        if (imgret.status) {
          // console.log(api.fsDir+'/unarchive/logo/'+logoret.data [0]+'/'+imgret.data[0]+'/info.txt');
          $(".logo").css("background-image",'url('+api.fsDir+'/unarchive/logo/'+logoret.data [0]+'/'+imgret.data[0]+'/tendentLogo.png'+')');
          //读取文件夹内容
          var fsSyncRet = fs.readByLengthSync({
              path: api.fsDir+'/unarchive/logo/'+logoret.data [0]+'/'+imgret.data[0]+'/info.txt',
          });
          if (fsSyncRet.status) {
            var isDevice=0;
            for (var i=0;i<fsSyncRet.content.split(",").length;i++) {
              var pair = fsSyncRet.content.split(",")[i].split(":");
            	if(pair[0] =="isDevice"){
            		isDevice=pair[1]
            	}
            }
            if(isDevice==1){
              $api.css($api.dom('.deiceRE'),'display:block')
            }
            // var content = fsSyncRet.content.slice(9,10);
          }
