    ...
    auiDialog.prototype = {
        ...
        create: function(params,callback) {
            ...
            if(params.input){
                ...
                if(params.title == "退回" || params.title == "转办") {
                  var msgHtml = '<div class="aui-dialog-body"><textarea id="dialogInput" type="text" placeholder="'+params.text+'"></textarea></div>';
                } else {
                  var msgHtml = '<div class="aui-dialog-body"><input id="dialogInput" type="text" placeholder="'+params.text+'"></div>';
                }
            }else{
            ...
            if (buttons && buttons.length > 0) {
                for (var i = 0; i < buttons.length; i++) {
                    if (i == 0) {
                      buttonsHtml += '<div style="color: #F52F2F;" class="aui-dialog-btn" tapmode button-index="'+i+'">'+buttons[i]+'</div>';
                    } else {
